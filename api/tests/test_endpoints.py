...
class TestAnomalyDetectionEndpoint:
    ...
    def test_detect_anomalies_insufficient_data(self, client):
        ...
        response = client.post(
            "/api/v1/anomaly/detect",
            json={
                "data": [{"value": 1.0}],  # Only 1 data point
                "contamination": 0.1
            }
        )
    ...
    def test_detect_anomalies_large_dataset(self, client):
        ...
        large_data = {
            "data": [
                {"price": 100 + np.random.normal(0, 1), "volume": 1000 + int(np.random.normal(0, 100))}
                for _ in range(1000)
            ],
            "contamination": 0.05
        }
    ...
    def test_realistic_financial_data(self, client):
        ...
        financial_data = {
            "data": [
                ...
                {"Open": 152.0, "High": 154.0, "Low": 151.0, "Close": 153.0, "Volume": 1100000},
                {"Open": 153.0, "High": 200.0, "Low": 152.0, "Close": 195.0, "Volume": 5000000},  # Anomaly
                {"Open": 153.0, "High": 155.0, "Low": 152.0, "Close": 154.0, "Volume": 1050000},
                {"Open": 154.0, "High": 156.0, "Low": 153.0, "Close": 155.0, "Volume": 1020000},
            ],
            "contamination": 0.2
        }
